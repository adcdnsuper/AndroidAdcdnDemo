 ...
 */
public class CustomLoadImageOnlyAdapter extends RecyclerView.Adapter<CustomLoadImageOnlyAdapter.CustomViewHolder> {

    static final int TYPE_DATA = 0;
    static final int TYPE_AD = 1;
    private List<Object> mData;

    public CustomLoadImageOnlyAdapter(List list) {
        mData = list;
    }
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        int layoutId = (viewType == TYPE_AD) ? R.layout.item_express_image_only_ad : R.layout.item_data;
